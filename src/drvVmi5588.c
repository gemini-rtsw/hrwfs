...
/* $Id: drvVmi5588.c,v 1.1.1.1 1999-03-17 03:14:22 cboyer Exp $
*
...
/* Stuff used by the EPICS driver only */
#ifndef NO_EPICS
struct {
    long            number;
    struct {
...
* and is responsible for turning off RM interrupts. This is necessary
...
)
{
    ...
    if (vmi5588Debug) {
        logMsg("vmi5588_pageISR: Interrupt from Node <%x>\n", 
               rmNodeId, 0,0,0,0,0);
    }
