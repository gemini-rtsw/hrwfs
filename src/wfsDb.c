static struct {void *v; char *c;} rcsid = {&rcsid,
	"$Id: wfsDb.c,v 1.1.1.1 1999-03-17 03:14:25 cboyer Exp $"};
...
CAD_RECORD pWfsDbCadList [] =
{
	...
	},
	{
		...
		CAD_ATTRIB_B, EPICS_DATA_TYPE_DOUBLE, 	"1.0",			{"0.0001", "10000.0"}
	},
	{
		RECORD_NAME ("p1:detObstype"),
		TASK_NAME ("p1", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_OBSTYPE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		40.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	"WFS",			{"WFS", "DARK", "FLAT", "ZNULL"},
	},
	{
		RECORD_NAME ("p1:detSetWcs"),
		TASK_NAME ("p1", DET_CONTROL_TASK_NAME),
	...
	},
	{
		...
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"0",						{"0", "2"},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_DATA_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_STRING, 	"pwfs1.fits",				{NO_ATTRIBUTE_LIMITS},
	...
	},
	{
		...
		180.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,		{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING,	DET_CONTROL_PWFS1_OSPFGINI_FILE,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING,	"(NOT USED)",					{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("p1:detSigMode"),
		TASK_NAME ("p1", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_SIGMODE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		40.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_LONG, 	"4",						{"0", "8"},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"1",						{"1", NO_HI_LIMIT},
	...
	},
	{
		...
		120.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING, 	"p2params.par",				{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_LONG,		"-1",						{"-1", "3"}
	},
	{
		RECORD_NAME ("p2:detChop"),
		TASK_NAME ("p2", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_CHOP,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
	...
	},
	{
		...
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"0",						{"0", "2"},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_DATA_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_STRING, 	"pwfs2.fits",				{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_E, EPICS_DATA_TYPE_STRING, 	"NONE",						{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("p2:stop"),
	...
	{
		RECORD_NAME ("p2:detInit"),
		TASK_NAME ("p2", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_INITIALISE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		180.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_LONG, 	ATTRIB (DET_CONTROL_PWFS2_SDSU_ADRS_VME),
																				{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING,	DET_CONTROL_OMF_FILE_PATH,		{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING,	DET_CONTROL_OMF_VME_FILE,		{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_STRING,	DET_CONTROL_GBD_OMF_TIM_FILE,	{NO_ATTRIBUTE_LIMITS},
	...
	},
	{
		...
		CAD_ATTRIB_A, EPICS_DATA_TYPE_LONG, 	"1",			{"1", "20"},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"1",			{"1", "20"},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_LONG, 	"40",			{"1", ATTRIB (DET_CONTROL_PWFS2_XSIZE)},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_LONG, 	"40",			{"1", ATTRIB (DET_CONTROL_PWFS2_YSIZE)},
		CAD_ATTRIB_E, EPICS_DATA_TYPE_LONG, 	"1",			{"1", ATTRIB (DET_CONTROL_PWFS2_XSIZE)},
		CAD_ATTRIB_F, EPICS_DATA_TYPE_LONG, 	"1",			{"1", ATTRIB (DET_CONTROL_PWFS2_YSIZE)},
		CAD_ATTRIB_G, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_PWFS2_XSIZE)},
		CAD_ATTRIB_H, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_PWFS2_YSIZE)},
		CAD_ATTRIB_I, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_PWFS2_XSIZE)},
		CAD_ATTRIB_J, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_PWFS2_YSIZE)}
	},
	{
		RECORD_NAME ("p2:detPrim"),
		TASK_NAME ("p2", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_PRIMITIVE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
	...
	},
	{
		...
		180.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,		{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING,	DET_CONTROL_PWFS2_OSPFGINI_FILE,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING,	"(NOT USED)",					{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("p2:detSigMode"),
		TASK_NAME ("p2", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_SIGMODE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
	...
	{
		RECORD_NAME ("oi:detSetup"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_SETUP,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		120.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING, 	"oiparams.par",				{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_LONG,		"-1",						{"-1", "3"}
	},
	{
		RECORD_NAME ("oi:detChop"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_CHOP,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
	...
	},
	{
		...
		120.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING, 	"oicalib.wcs",				{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("oi:observe"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_OBSERVE,
		STOP_DIRECTIVE_SUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		...
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"0",						{"0", "2"},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_DATA_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_STRING, 	"oiwfs.fits",				{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_E, EPICS_DATA_TYPE_STRING, 	"NONE",						{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("oi:stop"),
	...
	},
	{
		...
		120.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING, 	"oinewparams.par",			{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_LONG,		"-1",						{"-1", "3"}
	},
	{
		RECORD_NAME ("oi:detGeometry"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_GEOMETRY,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
		...
		CAD_ATTRIB_A, EPICS_DATA_TYPE_LONG, 	"1",			{"1", "20"},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_LONG, 	"1",			{"1", "20"},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_LONG, 	"40",			{"1", ATTRIB (DET_CONTROL_OIWFS_XSIZE)},
		CAD_ATTRIB_D, EPICS_DATA_TYPE_LONG, 	"40",			{"1", ATTRIB (DET_CONTROL_OIWFS_YSIZE)},
		CAD_ATTRIB_E, EPICS_DATA_TYPE_LONG, 	"1",			{"1", ATTRIB (DET_CONTROL_OIWFS_XSIZE)},
		CAD_ATTRIB_F, EPICS_DATA_TYPE_LONG, 	"1",			{"1", ATTRIB (DET_CONTROL_OIWFS_YSIZE)},
		CAD_ATTRIB_G, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_OIWFS_XSIZE)},
		CAD_ATTRIB_H, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_OIWFS_YSIZE)},
		CAD_ATTRIB_I, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_OIWFS_XSIZE)},
		CAD_ATTRIB_J, EPICS_DATA_TYPE_LONG, 	"0",			{"0", ATTRIB (DET_CONTROL_OIWFS_YSIZE)}
	},
	{
		RECORD_NAME ("oi:detPrim"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_PRIMITIVE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
	...
	},
	{
		...
		120.0,
		CAD_ATTRIB_A, EPICS_DATA_TYPE_STRING, 	DET_CONTROL_PAR_FILE_PATH,		{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_B, EPICS_DATA_TYPE_STRING,	DET_CONTROL_OIWFS_OSPFGINI_FILE,	{NO_ATTRIBUTE_LIMITS},
		CAD_ATTRIB_C, EPICS_DATA_TYPE_STRING,	"(NOT USED)",					{NO_ATTRIBUTE_LIMITS}
	},
	{
		RECORD_NAME ("oi:detSigMode"),
		TASK_NAME ("oi", DET_CONTROL_TASK_NAME),
		DET_CONTROL_CMD_SIGMODE,
		STOP_DIRECTIVE_UNSUPPORTED,
		SIMULATION_MODE_SUPPORTED,
...
SIR_RECORD	pWfsDbSirList [] =
{
	...
	{
		RECORD_NAME ("p1:state"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p1:health"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p1:testResults"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p1:detPrimReply"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p1:detInitStatus"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p1:initialising"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("p1:observing"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("p2:name"),
	...
	{
		RECORD_NAME ("p2:state"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p2:health"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p2:testResults"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p2:detPrimReply"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p2:detInitStatus"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("p2:initialising"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("p2:observing"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("oi:name"),
	...
	{
		RECORD_NAME ("oi:state"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("oi:health"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("oi:testResults"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("oi:detPrimReply"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("oi:detInitStatus"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("oi:initialising"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("oi:observing"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("hr:name"),
	...
	{
		RECORD_NAME ("hr:state"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("hr:health"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("hr:testResults"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("hr:detPrimReply"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("hr:detInitStatus"),
		EPICS_DATA_TYPE_STRING
	},
	{
		RECORD_NAME ("hr:initialising"),
		EPICS_DATA_TYPE_LONG
	},
	{
		RECORD_NAME ("hr:observing"),
		EPICS_DATA_TYPE_LONG
	}
};
