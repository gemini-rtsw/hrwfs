static struct {void *v; char *c;} rcsid = {&rcsid,
	"$Id: errorLib.c,v 1.1.1.1 1999-03-17 03:14:22 cboyer Exp $"};
 ...
 *	errorWrite  			- Log info. from current error context to current logging destination
 ...
 *	errorLogConsoleEnable	- Enable or disable the copying of messages to the console
 *	errorLogMessage			- Log an information message to the current logging destination
...
BOOL	errorLogAll = FALSE;		/* When this flag is set all errors are logged immediately		*/
BOOL	errorLogConsole = FALSE;	/* When this flag is set all errors are copied to the console	*/
