...
--------------------
---,08oct98,srp  SRP_REG added to set up MV167 ECC memory expansion card.
...
typedef struct
{
    ...
    unsigned char dramCtrl;
    unsigned char pad7[3];
    unsigned char clkFreq;
} eccStruct;
...
int setMemChip(void)
{
    eccStruct *pBase = (eccStruct *)0xfff43000;

    pBase->chipId	= 0x81;
    pBase->chipRevision	= 0x00;
    pBase->memConfig	= 0x12;
    pBase->dummy0	= 0x00;
    pBase->dummy1	= 0x00;
    pBase->baseAddr	= 0x00;
    pBase->dramCtrl	= 0x01;
