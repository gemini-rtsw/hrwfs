...
w 1106 -85 100 0 n#120 ecalcouts.waitState.FLNK 864 -96 1408 -96 1408 96 junction
...
[cell use]
use ecalcouts 544 -281 100 0 waitState
xform 0 704 -160
p 624 -240 100 0 -1 CALC:A
p 608 -336 100 0 1 OOPT:On Change
p 608 -400 100 0 1 PV:$(sadtop)
p 608 -368 100 0 1 SCAN:Passive
p 112 -96 100 0 1 def(INPA):$(agtop)cc:state.VAL
p 608 -400 100 0 0 name:$(sadtop)$(I)
p 496 -88 75 0 -1 pproc(INPA):CPP
...
p 2592 2336 200 0 -1 id:$Id: systemSad.sch,v 1.4 2001-10-26 03:28:00 cboyer Exp $
