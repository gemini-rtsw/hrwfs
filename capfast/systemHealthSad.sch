...
[tools]
[detail]
w 1528 395 100 0 n#73 ecalcouts.waitHealth.FLNK 1280 384 1824 384 1824 672 junction
...
[cell use]
use ecalcouts 960 199 100 0 waitHealth
xform 0 1120 320
p 1032 232 100 0 -1 CALC:A
p 1024 144 100 0 1 OOPT:On Change
p 1024 80 100 0 1 PV:$(sadtop)
p 1024 112 100 0 1 SCAN:Passive
p 496 384 100 0 1 def(INPA):$(agtop)cc:health.VAL
p 1024 200 100 0 0 name:$(top)$(I)
p 912 392 75 0 -1 pproc(INPA):CPP
...
p 2016 416 100 0 1 def(INPE):$(agtop)cc:health.VAL
...
p 3184 -688 200 0 -1 date:$Date: 2001-10-26 03:28:00 $
p 2592 2336 200 0 -1 id:$Id: systemHealthSad.sch,v 1.3 2001-10-26 03:28:00 cboyer Exp $
