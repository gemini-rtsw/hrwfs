...
[cell use]
use esirs 2368 -217 100 0 oscan
xform 0 2576 -64
p 2432 -256 100 0 1 DESC:Column number per output of the overscan region
p 2304 -480 100 0 0 FDSC:SDSU parameter YBIN
...
use esirs 1152 -217 100 0 adc0
xform 0 1360 -64
p 1216 -256 100 0 1 DESC:ADC 0
p 1088 -480 100 0 0 FDSC:SDSU parameter T_ADC_OS0
p 1216 -288 100 0 1 FTVL:LONG
p 1216 -320 100 0 1 PV:$(sadtop)$(wfs)
use esirs 1760 -217 100 0 adc1
xform 0 1968 -64
p 1824 -256 100 0 1 DESC:ADC 1
p 1696 -480 100 0 0 FDSC:SDSU parameter T_ADC_OS1
...
p 2576 2320 200 0 -1 id:$Id: wfsDetSad.sch,v 1.5 2001-06-05 02:58:04 cboyer Exp $
