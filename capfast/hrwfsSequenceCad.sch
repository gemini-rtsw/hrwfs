...
use ecad2 1600 167 100 0 endGuide
xform 0 1760 480
p 1664 128 100 0 1 DESC:endGuide
p 1712 544 100 0 0 FTVA:STRING
p 1712 480 100 0 0 FTVB:STRING
p 1664 96 100 0 1 INAM:epToVxCadInit
p 1664 32 100 0 1 PV:$(top)
p 1664 64 100 0 1 SNAM:epToVxCadExecute
...
use ecad2 448 999 100 0 simulate
xform 0 608 1312
p 512 960 100 0 1 DESC:Set simulation mode
p 560 1376 100 0 1 FTVA:STRING
p 560 1312 100 0 1 FTVB:STRING
p 512 928 100 0 1 INAM:epToVxCadInit
p 512 864 100 0 1 PV:$(top)
p 512 896 100 0 1 SNAM:epToVxCadExecute
use ecad2 1600 999 100 0 debug
xform 0 1760 1312
p 1664 960 100 0 1 DESC:Set debugging mode
p 1712 1376 100 0 1 FTVA:STRING
p 1712 1312 100 0 1 FTVB:STRING
...
use ecad2 2816 999 100 0 verify
xform 0 2976 1312
p 2880 960 100 0 1 DESC:Verify
...
use ecad2 2816 167 100 0 endObserve
xform 0 2976 480
p 2880 128 100 0 1 DESC:endObserve
p 2928 544 100 0 0 FTVA:STRING
p 2928 480 100 0 0 FTVB:STRING
p 2880 96 100 0 1 INAM:epToVxCadInit
p 2880 32 100 0 1 PV:$(top)
p 2880 64 100 0 1 SNAM:epToVxCadExecute
...
p 2992 -448 200 0 -1 date:$Date: 2000-02-03 01:17:45 $
p 2480 2656 200 0 -1 id:$Id: hrwfsSequenceCad.sch,v 1.3 2000-02-03 01:17:45 cboyer Exp $
