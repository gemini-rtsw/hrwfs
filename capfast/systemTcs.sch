...
s -192 1632 200 0 Records used by TCS time system
s 2240 -336 500 512 systemTcs.sch
s -592 2528 500 0 Wavefront Sensing - System TCS Interface Records
[cell use]
use esirs 0 1287 100 0 health
xform 0 208 1440
p 64 1232 100 0 1 DESC:TCS time system health
p -64 1024 100 0 0 FDSC:
p 64 1200 100 0 1 PV:$(top)TIME:
...
p 2992 -448 200 0 -1 date:$Date: 2000-05-10 19:43:20 $
p 2480 2656 200 0 -1 id:$Id: systemTcs.sch,v 1.4 2000-05-10 19:43:20 cboyer Exp $
